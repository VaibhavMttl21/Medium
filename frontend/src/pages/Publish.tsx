...
export const Publish =()=>
{
    ...
    return  <div>
        ...
        focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 mt-6" placeholder="Title"></input> 
    </div>
    </div> 
    <div className="flex justify-center">
...
return <form>
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50  ">
       ...
       <div className=" bg-white rounded-b-lg ">
           ...
           <textarea onChange={onChange} id="editor" rows={9} className="focus:outline-none block w-full px-0 text-sm text-gray-800 bg-white border-0  focus:ring-0 " placeholder="Write an article..." required ></textarea>
       </div>
   </div>
</form>
